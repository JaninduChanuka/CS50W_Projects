...
function add_html(id, username, post, time, link) {
    ...
    span1.setAttribute("class", "text-dark fs-5 fw-bold");
    ...
    span3.setAttribute("class", "text-primary edit fw-bold");
    ...
    img.setAttribute(
        "src",
        "https://img.icons8.com/fluency-systems-filled/35/null/hearts.png"
    );
    like_handeler(img);
